...
- P1 QA 答疑刷写收口：同一用户同一求助只能保留一份活跃答疑，单个求助最多 50 份活跃答疑；在线快照在生成 Excel 文件前先做额度拦截。
...
- 运行标准部署脚本上线应用提交 `62caced`，服务器备份为 `/www/wwwroot/excelcc/kick-deploy/backups/20260521-071447`。
