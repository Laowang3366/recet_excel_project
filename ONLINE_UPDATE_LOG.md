...
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit 2de97ca; health check and service status were printed by the deploy script.
...
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260529-141754
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-28 19:33 Asia/Shanghai

- Scope: 题库动态数组溢出、真实工作表预览与创建向导校验修复
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit b442c98; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260528-113221
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-28 17:39 Asia/Shanghai

- Scope: AI助手模块最新分支合并上线
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit f1ec81f; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260528-093812
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-27 22:54 Asia/Shanghai

- Scope: 题库上传答案照片入口上线
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit fd98bd4; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260527-145355
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-27 18:51 Asia/Shanghai

- Scope: 题库管理模块向导重构合并上线
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit ed9e22b; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260527-105054
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-27 18:18 Asia/Shanghai

- Scope: 模板中心后续修复合并上线
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit d732755; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260527-101748
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
...
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit 533ba8a; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260527-065959
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-27 14:24 Asia/Shanghai

- Scope: 后台模块重构集成上线
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit 16a7352; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260527-062353
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-26 23:29 Asia/Shanghai

- Scope: 后台用户管理统计指标与首次登录改密收口
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit d483b25; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260526-152838
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
...
- Scope: 后台通知与用户管理界面重构
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit e4ae6f9; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260526-123811
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-26 12:38 Asia/Shanghai

- Scope: 修复后台通知弹窗横向错位布局
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit b054b0d; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260526-043749
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-26 01:03 Asia/Shanghai

- Scope: 后台通知新建编辑与发送确认弹窗重构
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit 59afd64; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260525-170252
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-26 00:26 Asia/Shanghai

- Scope: 后台通知管理界面与头像返回前台提示优化
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit da8c8ef; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260525-162509
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-26 00:02 Asia/Shanghai

- Scope: 后台顶部导航栏与侧边栏样式重构
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit cfccbdc; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260525-160101
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
## 2026-05-25 23:48 Asia/Shanghai

- Scope: 后台首页内容预览分类弹窗与批量排序优化
- Verification: local one-click deploy script completed; https://www.excelcc.cn/ -> 200; https://www.excelcc.cn/api/public/home-overview -> 200; https://www.excelcc.cn/practice -> 200; https://www.excelcc.cn/api/practice/campaign/chapters -> 200; remote standard deploy completed for runtime commit 6351781; health check and service status were printed by the deploy script.
- Deploy: local scripts/deploy/push-and-deploy.ps1 pushed origin/main, then ran bash scripts/deploy/production-deploy.sh in /www/wwwroot/excelcc/kick-deploy/repo on the server.
- Server backup: /www/wwwroot/excelcc/kick-deploy/backups/20260525-154723
- Notes: generated by the one-click deploy script; /www/wwwroot/quick-translate was not changed.
