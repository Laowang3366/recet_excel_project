...
async function apiRequestInternal<T = unknown>(path: string, options: RequestOptions, retryCount: number): Promise<T> {
...
export const api = {
  ...
  delete: <T = unknown>(path: string, body?: unknown, options?: Omit<RequestOptions, "method" | "body">) =>
