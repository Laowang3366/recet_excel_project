...
export const router = createBrowserRouter([
  { path: "/auth", lazy: lazyPage(() => import("./pages/Auth"), "Auth") },
  {
    ...
    children: [
      ...
      { path: "file-recycle-bin", lazy: lazyPage(() => import("./pages/AdminFileRecycleBin"), "AdminFileRecycleBin") },
  ...
  },
  {
    ...
    children: [
      ...
      pageRoute("qa", () => import("./pages/QaCenter"), "QaCenter"),
      pageRoute("qa/my", () => import("./pages/MyQaCenter"), "MyQaCenter"),
      pageRoute("qa/cases/:id", () => import("./pages/QaCaseDetail"), "QaCaseDetail"),
      pageRoute("qa/cases/:id/answer", () => import("./pages/QaCaseAnswer"), "QaCaseAnswer"),
      pageRoute("qa/solutions/:id", () => import("./pages/QaSolutionDetail"), "QaSolutionDetail"),
      ...
      pageRoute("tools/convert", () => import("./pages/ToolsConvert"), "ToolsConvert"),
